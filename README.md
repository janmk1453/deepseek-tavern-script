...
- **新价格机制**：兼容 DeepSeek 7月中旬后的峰谷定价机制，支持设置生效日期
...
#### 修复
- 历史记录中点击📄查看完整使用数据显示相同数据的问题
- 使用详情面板在桌面端尺寸过大，调整为合适大小

#### 改进
- 展示详情面板新增请求参数（fullRequest）和 API 完整响应（fullResponse）字段
- 展示详情面板结构化显示请求参数、响应数据、Token 用量等信息
