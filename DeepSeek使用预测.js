...
function init() { 
  ...
  function normalizeImportData(raw) {
    ...
    if (settings.useNewPricing === undefined) settings.useNewPricing = false;
    if (settings.newPricingDate === undefined) settings.newPricingDate = new Date('2026-07-15T00:00:00+08:00').getTime();
    d.settings = settings;
