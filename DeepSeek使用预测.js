...
function init() { 
  ...
  function generateDebugBatch() {
    ...
    var model = state.settings.debugModel || 'deepseek-v4-flash';
...
function createChartUI() {
  ...
  panel.innerHTML = '<div style="padding:12px 16px;background:#080d14;border-bottom:1px solid #374151;display:flex;justify-content:space-between;align-items:center;flex-shrink:0"><div style="display:flex;align-items:center;gap:8px"><span style="font-size:16px;font-weight:600;color:#f3f4f6;font-family:\'Microsoft YaHei\',\'微软雅黑\',sans-serif">统计详情</span><div id="ds-chart-model-group" style="display:flex;gap:4px;margin-left:8px">' +
    '<label style="font-size:11px;padding:3px 8px;border-radius:4px;background:#1e293b;color:#93c5fd;cursor:pointer;border:1px solid transparent;font-family:\'Microsoft YaHei\',\'微软雅黑\',sans-serif"><input type="radio" name="ds-chart-model" value="deepseek-v4-flash" style="display:none" checked><span>v4-flash</span></label>' +
    '<label style="font-size:11px;padding:3px 8px;border-radius:4px;background:#1e293b;color:#a5b4fc;cursor:pointer;border:1px solid transparent;font-family:\'Microsoft YaHei\',\'微软雅黑\',sans-serif"><input type="radio" name="ds-chart-model" value="deepseek-v4-pro" style="display:none"><span>v4-pro</span></label>' +
...
function renderHeatmap(filtered, dayAgg) {
  ...
  var clr = ['#161b22','#082e16','#2da44e','#4ac26b','#aceebb'];
